...
const Hero = () => {
  return (
    <section className='h-[calc(100vh-58px)] w-full relative overflow-hidden'>
      ...
      <Wrapper className='absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 z-20 text-center text-white w-full'>
        ...
        <p className='font-medium sm:text-fluid-sm max-w-[60ch] mx-auto leading-tight text-white'>
